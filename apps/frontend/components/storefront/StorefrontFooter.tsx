        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 md:gap-12">
          ...
          <div className="space-y-4">
            ...
            <p className="text-sm leading-relaxed text-gray-400">
              Discover our curated collection of quality clothing. We bring you the latest trends with exceptional service.
            </p>
            {/* Social Links */}
            ...
            <ul className="space-y-3 text-sm">
              {shop.email && (
                <li className="flex items-start space-x-2">
                  ...
                  <a href={`mailto:${shop.email}`} className="hover:text-white transition-colors break-all">
                    {shop.email}
                  </a>
                </li>
              )}
              {shop.phone && (
                <li className="flex items-start space-x-2">
                  ...
                  <a href={`tel:${shop.phone}`} className="hover:text-white transition-colors">
                    {shop.phone}
                  </a>
                </li>
              )}
          ...
          <div className="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
            ...
            <div className="flex items-center space-x-4">
              ...
              <div className="flex items-center space-x-2">
                ...
                <div className="w-8 h-5 bg-gray-700 rounded flex items-center justify-center text-[8px] text-gray-400 font-mono">
                  VISA
                </div>
                <div className="w-8 h-5 bg-gray-700 rounded flex items-center justify-center text-[8px] text-gray-400 font-mono">
                  MC
            ...
            <p className="text-xs text-gray-500">
              Powered by <span className="font-semibold text-gray-400">Busi</span>
            </p>
          </div>
        </div>
      </div>
