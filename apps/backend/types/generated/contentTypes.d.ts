...
export interface ApiProductProduct extends Schema.CollectionType {
  ...
  info: {
    ...
    pluralName: 'products';
    displayName: 'Product';
    description: 'Shop products/items for sale';
  };
  options: {
    draftAndPublish: false;
  };
  attributes: {
    ...
    sizes: Attribute.JSON & Attribute.DefaultTo<[]>;
    colors: Attribute.JSON & Attribute.DefaultTo<[]>;
...
export interface ApiShopShop extends Schema.CollectionType {
  ...
  info: {
    ...
    pluralName: 'shops';
    displayName: 'Shop';
    description: 'Multi-tenant shop/boutique';
  };
  options: {
    draftAndPublish: false;
  };
  attributes: {
    ...
    customDomain: Attribute.String & Attribute.Unique;
    logo: Attribute.Media<'images'>;
    primaryColor: Attribute.String & Attribute.DefaultTo<'#000000'>;
    secondaryColor: Attribute.String & Attribute.DefaultTo<'#ffffff'>;
    font: Attribute.Enumeration<
      ['inter', 'playfair', 'montserrat', 'roboto', 'poppins']
    > &
    ...
    isActive: Attribute.Boolean & Attribute.DefaultTo<true>;
    plan: Attribute.Enumeration<['free', 'starter', 'pro']> &
